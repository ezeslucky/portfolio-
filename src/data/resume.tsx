...
export const DATA = {
  ...
  skills: [
    ...
    "Prometheus",
    "Figma",
    "GenAI", "Langchain", "OpenAI", "Streamlit", "Ollama", "Google ADK", "DSA"
  ],
  navbar: [
